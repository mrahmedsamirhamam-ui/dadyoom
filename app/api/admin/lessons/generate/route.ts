...
async function readPdfLessonSource(
  ...
  if (
    ...
    throw new Error(
      "حدد صفحة بداية الدرس وصفحة نهايته داخل ملف PDF."
    );
  }
  ...
  if (
    ...
    throw new Error(
      "لا يمكن معالجة أكثر من 12 صفحة PDF للدرس الواحد."
    );
  }
  ...
  if (
    ...
    throw new Error(
      "ملف PDF كبير جدًا لمعالجة الدرس."
    );
  }
  ...
  if (
    ...
    throw new Error(
      `نطاق الصفحات يتجاوز عدد صفحات الملف (${totalPages}).`
    );
  }
  ...
  if (
    ...
    throw new Error(
      "حجم صفحات الدرس المحددة أكبر من الحد المسموح للمعالجة."
    );
  }
  ...
  if (!apiKey) {
    throw new Error(
      "مفتاح Gemini غير متاح لتحليل ملف PDF."
    );
  }
...
`;
  ...
  if (!rawText) {
    throw new Error(
      "لم يرجع Gemini نصًا من ملف PDF."
    );
  }
  ...
  if (
    ...
    throw new Error(
      "استجابة تحليل PDF ليست JSON صالحة."
    );
  }
  ...
  if (!content) {
    throw new Error(
      "لم يتم استخراج نص صالح من صفحات PDF."
    );
  }
