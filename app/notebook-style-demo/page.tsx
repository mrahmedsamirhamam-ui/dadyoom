...
export default function NotebookStyleDemoPage() {
  ...
  return (
    <main
      dir="rtl"
      className="min-h-screen bg-[#f4f1e8] px-3 py-5 sm:px-6 sm:py-8"
    >
      <div className="mx-auto max-w-7xl">
        <header className="mb-5 flex flex-col gap-3 rounded-[1.75rem] border border-[#dec99a] bg-[#fffdf8] px-5 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-xs font-black text-[#a37725]">
              نموذج ضاديوم — Notebook Style
            </p>
            <h1 className="mt-1 font-arabic-display text-2xl font-black text-[#123f39] sm:text-3xl">
              النكرة والمعرفة
            </h1>
          ...
          <div className="rounded-full bg-[#123f39] px-4 py-2 text-sm font-black text-white">
        ...
        <section className="overflow-hidden rounded-[2rem] border border-[#d8c18c] bg-[#0b2f2b] shadow-2xl shadow-[#123f39]/15">
          <div className="h-1.5 bg-[#173f38]">
            <div
              className="h-full bg-[#e1b852] transition-all duration-300"
              style={{
          ...
          <div className="relative flex min-h-[55vh] items-center justify-center bg-[#efe8d9] p-2 sm:p-4 lg:min-h-[72vh]">
            <img
              key={slides[current]}
              src={slides[current]}
              alt={`شريحة ${current + 1} من درس النكرة والمعرفة`}
            ...
            <button
              ...
              className="absolute right-3 top-1/2 grid h-12 w-12 -translate-y-1/2 place-items-center rounded-full bg-[#123f39]/95 text-3xl font-black text-white shadow-lg transition hover:scale-105 disabled:opacity-20 sm:right-6"
            >
              ›
            </button>
            ...
            <button
              ...
              className="absolute left-3 top-1/2 grid h-12 w-12 -translate-y-1/2 place-items-center rounded-full bg-[#123f39]/95 text-3xl font-black text-white shadow-lg transition hover:scale-105 disabled:opacity-20 sm:left-6"
            >
              ‹
            </button>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 border-t border-white/10 bg-[#123f39] px-4 py-4">
            {slides.map((_, index) => (
              <button
                ...
                className={
                  index === current
                    ? "h-2.5 w-8 rounded-full bg-[#e1b852] transition-all"
