...
${generatedLesson.homework}`
  ...
  if (
    ...
    redirect(
      `/admin/lessons/new?error=${encodeURIComponent("لم يتم إنشاء أسئلة اختيار من متعدد صالحة لهذا الدرس.")}`
    );
  }
  ...
  if (
    ...
    redirect(
      `/admin/lessons/new?error=${encodeURIComponent("لم يتم إنشاء أنشطة صالحة لهذا الدرس.")}`
    );
  }
...
status:
  ...
  if (questionsError) {
    ...
    redirect(
      `/admin/lessons/new?error=${encodeURIComponent(
        `تعذر حفظ أسئلة الدرس بعد إنشاء الدرس: ${questionsError.message}`
      )}`
    );
  }
  ...
  if (activitiesError) {
    ...
    redirect(
      `/admin/lessons/new?error=${encodeURIComponent(
        `تعذر حفظ أنشطة الدرس بعد إنشاء الدرس: ${activitiesError.message}`
      )}`
    );
  }
  ...
  if (
    ...
    if (
      ...
      redirect(
        `/admin/lessons/new?error=${encodeURIComponent(
          `تعذر نشر أنشطة الدرس بعد إنشائه: ${activitiesPublishError.message}`
        )}`
      );
    }
    ...
    if (
      ...
      redirect(
        `/admin/lessons/new?error=${encodeURIComponent(
          `تعذر نشر الدرس بعد حفظ محتواه: ${lessonPublishError.message}`
        )}`
      );
    }
  }
